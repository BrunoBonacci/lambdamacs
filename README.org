...
| ~emmet-mode~   | ~C-j~ or ~C-u C-j~ | Expand emmet' style abbreviations                         | ~emmet~            |
...
- use ~C-j~ to expand [[https://github.com/smihica/emmet-mode#html-abbreviations][emmet's abbreviations]], use ~C-u C-j~ to preview the expansion
...
** License
Copyright © 2020-2025 Bruno Bonacci and contributors.
